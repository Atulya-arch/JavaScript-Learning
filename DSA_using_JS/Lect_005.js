...
const c1 = new Promise((resolve, reject) => setTimeout(() => reject("Error 1"), 3000));
const c2 = new Promise((resolve) => setTimeout(() => resolve("Success"), 1000));
const c3 = new Promise((resolve, reject) => setTimeout(() => reject("Error 2"), 2000));
